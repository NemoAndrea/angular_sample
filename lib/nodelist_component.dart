...
class NodeListComponent implements OnInit { //this implements OnInit, which means it MUST have a ngOnInit method
  ...
  void gotoDetail() { //we use this to use our router to navigate to the NodeDetailComponent*/ /*this is cool, because we can now do all sorts of complex navigational things
