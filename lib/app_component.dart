...
import 'node_data_service.dart'; //we need this to be able to load our node Data (see the dart file)

import 'node_detail_component.dart';  //this is another component we have created,
                                      // we must import it to be able to use it,
                                      // even if it is just for routing
import 'nodelist_component.dart';     //this is another component we have created,
                                      // we must import it to be able to use it,
                                      // even if it is just for routing
import 'hint_component.dart';         //this is another component we have created,
                                      // we must import it to be able to use it,
                                      // even if it is just for routing

//this is for a more advanced navigation within apps for more info:
//see the angular tutorial session on it (if my comments dont explain it properly)
...
//here we configure our routing. -  we can have multiple Route version - we need to have a <router-outlet> tag in our html, below that the router will load our components
